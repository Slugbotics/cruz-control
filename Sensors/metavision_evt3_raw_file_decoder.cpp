...
int main(int argc, char *argv[]) {
    ...
    while (input_file) {
        ...
        Metavision::Evt3::RawEvent *last_word = current_word + (unsigned long)input_file.gcount() / sizeof(Metavision::Evt3::RawEvent);
    ...
    const long duration_s = std::chrono::duration_cast<std::chrono::microseconds>(tp_end - tp_start).count() / 1e6;
