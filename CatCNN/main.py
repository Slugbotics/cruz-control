...
if __name__ == "__main__":
    ...
    for epoch in range(num_epochs):  # loop over the dataset multiple times
        ...
        for i, (inputs, labels) in enumerate(trainloader, 0):
            # get the inputs and labels to gpu
    ...
    # testing code (comment out training code if you specifically want to test)
    #net.load_state_dict(torch.load("model.pth"))
    #net.eval()
    # Comment out above 2 lines if you want to train then test
    with torch.no_grad():
