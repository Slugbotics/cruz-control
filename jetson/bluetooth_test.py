...
#Notes: 
# Installed xboxdrv to get controller connected, do: sudo systemctl enable xboxdrv.service && sudo systemctl start xboxdrv.service
# https://askubuntu.com/questions/1394906/20-04-xbox-one-controller-not-working-via-bluetooth
